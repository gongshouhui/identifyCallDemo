...
@implementation YSUIConfigurationTemplate
...
- (NSArray *)themeTabBarItemImage {
    ...
    return @[[self getOriginImageWithName:@"message"],
             [self getOriginImageWithName:@"contact"],
             [self getOriginImageWithName:@"application"],
             [self getOriginImageWithName:@"mine"],
             ];
   
}

- (NSArray *)themeTabBarItemImageSelected {
    return @[[self getOriginImageWithName:@"message_selected"],
             [self getOriginImageWithName:@"contact_selected"],
             [self getOriginImageWithName:@"application_selected"],
             [self getOriginImageWithName:@"mine_selected"],
             ];
}
/**tabbar item正常状态下的颜色*/
...
- (UIImage *)themeContactBackgroundImage {
    return [UIImage imageNamed:@"contact_bg"];
}
...
- (UIImage *)themeWorkItemImageWithItemType:(WorkbenchItemType)itemType {
    ...
    if(itemType == WorkbenchItemCRM) {
        return [UIImage imageNamed:@"icon-crm"];
    }
...
- (NSArray<UIImage *> *)themeGuideImages {
    ...
    [imageArray addObject:[UIImage imageNamed:@"guidance1"]];
    [imageArray addObject:[UIImage imageNamed:@"guidance2"]];
    [imageArray addObject:[UIImage imageNamed:@"guidance3"]];
    return [imageArray copy];
    
}
- (UIImage *)workBenchBannerImage {
    return [UIImage imageNamed:@"benner"];
}
