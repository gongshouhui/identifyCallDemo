//
//  YSUIConfigurationTemplateGrapefruit.m
//  YaSha-iOS
//
...
@implementation YSUIConfigurationTemplateGrapefruit
...
- (UIColor *)themeTintColor {
    return [UIColor colorWithRed:0.74 green:0.23 blue:0.21 alpha:1.00];
}
...
- (NSArray *)themeTabBarItemImage {
    return @[@"message(newyear)", @"contact(newyear)", @"application(newyear)", @"mine(newyear)"];
}

- (NSArray *)themeTabBarItemImageSelected {
    return @[@"message_selected(newyear)", @"contact_selected(newyear)", @"application_selected(newyear)", @"mine_selected(newyear)"];
}

- (NSString *)themeTabBarBackgroundImage {
    return @"tabBarBackgroundImage(newyear)";
}
