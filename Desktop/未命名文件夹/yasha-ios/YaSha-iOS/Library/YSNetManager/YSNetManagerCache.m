...
static NSString * const kYSNetManagerCache = @"YSNetManagerCache";
static  YYCache *_dataCache;

@implementation YSNetManagerCache

+ (void)initialize {
    _dataCache = [YYCache cacheWithName:kYSNetManagerCache];
}
...
+ (void)ys_setHttpCache:(id)httpData
    ...
    NSString *cacheKey = [self ys_cacheWithUrlString:urlString parameters:parameters];
