//
//  YSPMSMQFinanceInfoViewController.m
//  YaSha-iOS
//
...
@interface YSPMSMQFinanceInfoViewController ()
...
@implementation YSPMSMQFinanceInfoViewController
...
- (void)doNetworking {
    [YSNetManager ys_request_GETWithUrlString:[NSString stringWithFormat:@"%@%@/%@",YSDomain, getFinanceListAppMQ, self.projectId] isNeedCache:NO parameters:nil successBlock:^(id response) {
        DLog(@"------%@",response);
