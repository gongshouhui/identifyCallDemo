...
#import "YSFlowNewAuthorizedAdjustController.h"
#import "YSNewRecruitAuthorizedAdjustViewModel.h"
@interface YSFlowNewAuthorizedAdjustController ()

@end

@implementation YSFlowNewAuthorizedAdjustController

- (void)loadView {
	[super loadView];
	self.viewModel = [[YSNewRecruitAuthorizedAdjustViewModel alloc]initWithFlowTpe:self.flowType andflowInfo:self.flowModel];
}
