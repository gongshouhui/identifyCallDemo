...
#import "YSFlowNewOfferApplyController.h"
#import "YSFlowNewOfferApplyViewModel.h"
@interface YSFlowNewOfferApplyController ()

@end

@implementation YSFlowNewOfferApplyController
- (void)loadView {
	[super loadView];
	self.viewModel = [[YSFlowNewOfferApplyViewModel alloc]initWithFlowTpe:self.flowType andflowInfo:self.flowModel];
}
