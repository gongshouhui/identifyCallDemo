...
#import "YSFlowNewRecruitLeaveAddController.h"
#import "YSFlowNewLeaveAddPersonViewModel.h"
#import "YSFlowFormListCell.h"
@interface YSFlowNewRecruitLeaveAddController ()

@end

@implementation YSFlowNewRecruitLeaveAddController

- (void)loadView {
	[super loadView];
	self.viewModel = [[YSFlowNewLeaveAddPersonViewModel alloc]initWithFlowTpe:self.flowType andflowInfo:self.flowModel];
}
