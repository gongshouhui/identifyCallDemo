...
#import "YSFlowNewLeaveAddPersonViewModel.h"
@implementation YSFlowNewLeaveAddPersonViewModel
...
- (void)setUpData:(NSDictionary *)dic {
	...
	for (int i = 0; i < [dic[@"personnelRecruitInfoList"] count]; i++) {
		...
		[self.dataSourceArray addObject:@{@"title":@"离职人员姓名",@"content":detailDic[@"personnelName"]}];
		[self.dataSourceArray addObject:@{@"title":@"离职人员岗位",@"content":detailDic[@"personnelPostName"]}];
		[self.dataSourceArray addObject:@{@"title":@"离职日期",@"content":detailDic[@"personnelDate"]}];
