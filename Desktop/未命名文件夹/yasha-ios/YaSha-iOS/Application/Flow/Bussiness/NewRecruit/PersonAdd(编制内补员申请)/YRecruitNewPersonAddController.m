...
#import "YRecruitNewPersonAddController.h"
#import "YSNewRecruitPersonAddViewModel.h"
#import "YSFlowFormListCell.h"
@interface YRecruitNewPersonAddController ()

@end

@implementation YRecruitNewPersonAddController

- (void)loadView {
	[super loadView];
	self.viewModel = [[YSNewRecruitPersonAddViewModel alloc]initWithFlowTpe:self.flowType andflowInfo:self.flowModel];
}
...
//	YSNewRecruitPersonAddViewModel *viewModel = (YSNewRecruitPersonAddViewModel *)self.viewModel;
