...
@implementation YSNewRecruitPersonAddViewModel
...
- (void)setUpData:(NSDictionary *)dic {
	...
	for (int i = 0; i < [dic[@"personnelRecruitInfoList"] count]; i++) {
		...
		[self.dataSourceArray addObject:@{@"title":@"岗位名称",@"content":detailDic[@"postName"]}];
		[self.dataSourceArray addObject:@{@"title":@"职务类别",@"content":detailDic[@"PositionRankName"]}];
		[self.dataSourceArray addObject:@{@"title":@"期望时间",@"content":detailDic[@"expectedDate"]}];
		[self.dataSourceArray addObject:@{@"title":@"招聘人数",@"content":[NSString stringWithFormat:@"%@",detailDic[@"needRecruitNum"]]}];
