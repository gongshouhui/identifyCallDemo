//
//  YSFlowTenderIsChooseNewViewController.m
//  YaSha-iOS
//
...
@interface YSFlowTenderIsChooseNewViewController ()
...
@implementation YSFlowTenderIsChooseNewViewController
...
- (void)doNetworking {
    NSDictionary *dic = @{@"tenderBidId":self.id,
                          @"isBid":[NSString stringWithFormat:@"%zd",self.flowTenderType]
                          };
    DLog(@"=======%@",dic);
...
- (UIView *)tableView:(UITableView *)tableView viewForFooterInSection:(NSInteger)section {
    UIView *footerView = [[UIView alloc] initWithFrame:CGRectMake(0, 0, kSCREEN_WIDTH, 20*kHeightScale)];
    return footerView;
}
...
- (UIView *)tableView:(UITableView *)tableView viewForHeaderInSection:(NSInteger)section {
    ...
    [self.flowTenderHeaderView.dropDownImageView removeFromSuperview];
