...
#import "YSFlowOfferApplyController.h"
#import "YSFlowOfferApplyViewModel.h"
@interface YSFlowOfferApplyController ()

@end

@implementation YSFlowOfferApplyController
- (void)loadView {
	[super loadView];
	self.viewModel = [[YSFlowOfferApplyViewModel alloc]initWithFlowTpe:self.flowType andflowInfo:self.flowModel];
}
