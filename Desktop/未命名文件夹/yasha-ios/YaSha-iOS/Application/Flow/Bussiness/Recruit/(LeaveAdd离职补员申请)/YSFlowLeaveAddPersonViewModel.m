//
//  YSFlowLeaveAddPersonViewModel.m
//  YaSha-iOS
//
...
#import "YSFlowLeaveAddPersonViewModel.h"
#import "YSFlowJobDelineateViewController.h"
@implementation YSFlowLeaveAddPersonViewModel
...
- (void)setUpData:(NSDictionary *)dic {
	...
	for (int i = 0; i <[dic[@"personnelRecruitInfos"] count] ; i++) {
		...
		[self.dataSourceArray addObject:@{@"title":@"离职人员姓名",@"content":dic1[@"personnelName"]}];
		[self.dataSourceArray addObject:@{@"title":@"离职人员岗位",@"content":dic1[@"positionName"]}];
		[self.dataSourceArray addObject:@{@"title":@"离职日期",@"content":dic1[@"personnelDate"]}];
