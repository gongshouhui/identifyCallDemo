...
#import "YSFlowRecruitTransferApplyController.h"
#import "YSFlowTransferApplyViewModel.h"
#import "YSFlowFormListCell.h"
@interface YSFlowRecruitTransferApplyController ()

@end

@implementation YSFlowRecruitTransferApplyController

- (void)loadView {
	[super loadView];
	self.viewModel = [[YSFlowTransferApplyViewModel alloc]initWithFlowTpe:self.flowType andflowInfo:self.flowModel];
}
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
	YSFlowTransferApplyViewModel *viewModel = (YSFlowTransferApplyViewModel *)self.viewModel;
