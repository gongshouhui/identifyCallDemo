//
//  YSFlowRecruitLeaveAddController.m
//  YaSha-iOS
//
...
#import "YSFlowRecruitLeaveAddController.h"
#import "YSFlowLeaveAddPersonViewModel.h"
#import "YSFlowFormListCell.h"
@interface YSFlowRecruitLeaveAddController ()

@end

@implementation YSFlowRecruitLeaveAddController

- (void)loadView {
	[super loadView];
	self.viewModel = [[YSFlowLeaveAddPersonViewModel alloc]initWithFlowTpe:self.flowType andflowInfo:self.flowModel];
}
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
	YSFlowLeaveAddPersonViewModel *viewModel = (YSFlowLeaveAddPersonViewModel *)self.viewModel;
