...
#import "YSFlowTransferApplyViewModel.h"
#import "YSFlowJobDelineateViewController.h"
@implementation YSFlowTransferApplyViewModel
...
- (void)setUpData:(NSDictionary *)dic {
	...
	for (int i = 0; i <[dic[@"personnelRecruitInfos"] count] ; i++) {
		...
		[self.dataSourceArray addObject:@{@"title":@"调岗人员姓名",@"content":dic1[@"personnelName"]}];
		[self.dataSourceArray addObject:@{@"title":@"调岗人员岗位",@"content":dic1[@"positionName"]}];
		[self.dataSourceArray addObject:@{@"title":@"调岗往单位",@"content":dic1[@"transferToPosition"]}];
		[self.dataSourceArray addObject:@{@"title":@"调动日期",@"content":dic1[@"personnelDate"]}];
		[self.dataSourceArray addObject:@{@"title":@"补员职级",@"content":dic1[@"rankName"]}];
		[self.dataSourceArray addObject:@{@"title":@"期望时间",@"content":dic1[@"expectedDate"]}];
		[self.dataSourceArray addObject:@{@"title":@"岗位职责与要求",@"content":dic1[@"requirement"],@"expand":@(0),@"special":@(BussinessFlowCellExtend)}];
