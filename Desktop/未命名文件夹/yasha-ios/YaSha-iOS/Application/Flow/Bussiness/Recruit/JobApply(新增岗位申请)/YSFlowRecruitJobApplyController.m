//
//  YSFlowRecruitJobApplyController.m
//  YaSha-iOS
//
...
#import "YSFlowRecruitJobApplyController.h"
#import "YSFlowRecruitJobApplyViewModel.h"
#import "YSFlowFormListCell.h"

@interface YSFlowRecruitJobApplyController ()

@end

@implementation YSFlowRecruitJobApplyController

- (void)loadView {
	[super loadView];
	self.viewModel = [[YSFlowRecruitJobApplyViewModel alloc]initWithFlowTpe:self.flowType andflowInfo:self.flowModel];
}
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
	YSFlowRecruitJobApplyViewModel *viewModel = (YSFlowRecruitJobApplyViewModel *)self.viewModel;
