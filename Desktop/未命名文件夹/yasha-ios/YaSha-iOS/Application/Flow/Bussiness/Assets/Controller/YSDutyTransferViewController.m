//
//  YSDutyTransferViewController.m
//  YaSha-iOS
//
//  Created by YaSha_Tom on 2017/11/16.
//

#import "YSDutyTransferViewController.h"
#import "YSFlowExpressFormModel.h"
#import "YSFlowAssetsApplyFormModel.h"

@interface YSDutyTransferViewController ()
...
@implementation YSDutyTransferViewController
    ...
    [YSNetManager ys_request_GETWithUrlString:urlString isNeedCache:NO parameters:nil successBlock:^(id response) {
        ...
        if ([response[@"code"] intValue] == 1) {
            ...
            [self.flowDataSourceArray addObjectsFromArray:@[@[self.flowAssetsApplyFormListModel.applyNo,
                                                              self.flowAssetsApplyFormListModel.receiveManName == nil ? @"无数据":self.flowAssetsApplyFormListModel.receiveManName,
